...
4:                                                ; preds = %26, %3
  ...
  br i1 %5, label %.preheader4, label %28

.preheader4:                                      ; preds = %4
  br label %6

6:                                                ; preds = %.preheader4, %21
  %.02 = phi i32 [ %25, %21 ], [ 0, %.preheader4 ]
...
8:                                                ; preds = %.preheader, %10
  %.01 = phi i32 [ %19, %10 ], [ 0, %.preheader ]
  %.0 = phi i32 [ %20, %10 ], [ 0, %.preheader ]
